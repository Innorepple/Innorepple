    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
                    ...
                    if (auth.email != null) ...[
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(child: Text(auth.email!, style: const TextStyle(fontSize: 13, color: Colors.grey), overflow: TextOverflow.ellipsis)),
                        ],
                      ),
                    ],
                    if (auth.phone != null) ...[
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text(auth.phone!, style: const TextStyle(fontSize: 13, color: Colors.grey)),
                        ],
                      ),
                    ],
                    const SizedBox(height: 4),
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text(
                            auth.firebaseReady ? 'Firebase' : 'Local',
          ...
          ListTile(title: const Text('About'), trailing: const Icon(Icons.open_in_new), onTap: ()=> _open('https://innorepple.github.io/About/')),
          ListTile(
